  ...
  return (
    <div className="mt-20 flex gap-8 items-center justify-center pl-8 pr-8">
      <hr className="border-grey-100 w-full" />
        <Link href="callto: +2348023457784"><a className="p-3 pl-5 pr-5 bg-red-200 text-white rounded-xl text-sm whitespace-nowrap" title={+2348023457784}>Call Us Directly</a></Link>
