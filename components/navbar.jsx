...
const Navbar = () => {
  ...
  return (
    <nav className="max-w-container mr-auto ml-auto flex justify-between items-center pt-4 pb-4 text-sm">
      ...
      <div className={"bg-white w-1/2 h-full gap-8 text-red-100  transition-all " + ((nav) ? "left-0": "-left-1/2") + " font-normal md:font-light absolute top-0 pt-8 md:p-0 md:bg-opacity-0 md:items-center md:w-full md:h-0 md:text-white md:flex md:justify-end md:relative md:left-0"}>
